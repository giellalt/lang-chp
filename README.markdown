...
This directory contains source files for the Chipewyan language
...
-   <https://giellalt.uit.no/lang/chp/DenesulineDocumentation.html>
    (analyser)
...
The Chipewyan language sources can be acquired using [giella SVN
